...
public class Income extends Fragment {
    ...
    DBHandler db;
    private ArrayList<TransactionModal> incomeTransactionsList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view_final = inflater.inflate(R.layout.fragment_income, container, false);
    ...
    private void initializeViews(View view) {
        date = view.findViewById(R.id.select_date1);
        selected = view.findViewById(R.id.dispaly_Date1);
        search = view.findViewById(R.id.seacrh1);
        trxn_text=view.findViewById(R.id.no_trxn_inc);
    ...
    private void showTransactions(String start_date, String end_date) {
        ...
        Log.d("date_start",start);
        Log.d("date_end",end);
        incomeTransactionsList = db.readIncomeTransactions(start,end);
        int size = incomeTransactionsList.size();
        ...
        trxnRVAdapter = new TrxnRVAdapter(incomeTransactionsList, getActivity());
        trxnRV = view_final.findViewById(R.id.recyclerView_inc);
